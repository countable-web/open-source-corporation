...
Special tags:
  * #bug . Use a *red* label. Only for serious bugs, minor ones can just be regular cards. This card should result in a commit to the `master` branch and be deployed directly. It should normally precede other work.
